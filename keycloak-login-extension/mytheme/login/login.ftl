      ...
      <div id="kc-form-wrapper">
        <#if realm.password>
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <#if mobileNumberRequired!false>
                    <div class="${properties.kcFormGroupClass!}">
                        <label for="mobileNumber" class="${properties.kcLabelClass!}">${msg("mobileNumberText")}</label>

                        <input tabindex="3" id="mobileNumber" class="${properties.kcInputClass!}" name="mobileNumber" type="text" autocomplete="off"
                            aria-invalid="<#if messagesPerField.existsError('username','password')>true</#if>"
                        />
                    </div>
                </#if>
